...
public class ArrowScript : EquipmentItemScript
{
    ...
    public void Shoot(Vector3 power)
    {
        ...
        ObjectPool.Instance.PushToPool(Tags.Arrow, gameObject, DeviceRepository.RightDeviceInteraction.transform, 10);
        Invoke("NextArrow", 2f);
    }

    void NextArrow()
    {
        ObjectPool.Instance.PopFromPool(Tags.Arrow, DeviceRepository.RightDeviceInteraction.transform);
    }
