...
public class SteamVR : System.IDisposable
{
	...
	static SteamVR CreateInstance()
	{
		try
		{
			...
			{
				Debug.Log("OpenVR initialization failed.  Ensure 'Virtual Reality Supported' is checked in Sword Settings, and OpenVR is added to the list of Virtual Reality SDKs.");
				return null;
			}
